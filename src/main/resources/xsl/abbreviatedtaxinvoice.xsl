...
<xsl:stylesheet version="1.0"
    ...
    <xsl:template match="/rsm:AbbreviatedTaxInvoice_CrossIndustryInvoice">
        ...
        <xsl:variable name="delivery"   select="$txn/ram:ApplicableHeaderTradeDelivery"/>
        ...
        <fo:root>
            <fo:layout-master-set>
                <fo:simple-page-master master-name="abbreviatedtaxinvoice-page"
            ...
            <fo:page-sequence master-reference="abbreviatedtaxinvoice-page">
                <!-- Header -->
                                ...
                                <fo:table-row>
                                    ...
                                    <fo:table-cell>
                                        <fo:block text-align="right">
                                            ใบเสร็จรับเงิน/ใบกำกับภาษีอย่างย่ออิเล็กทรอนิกส์
                                        </fo:block>
                                    </fo:table-cell>
                                </fo:table-row>
                            </fo:table-body>
                ...
                <fo:flow flow-name="xsl-region-body">
                    ...
                    <!-- Seller only (no buyer for abbreviated tax invoice) -->
                    <fo:table width="100%" table-layout="fixed" space-after="8mm"
                        ...
                        <fo:table-body>
                            <fo:table-row>
                                <fo:table-cell>
                                    <fo:block background-color="#f5f5f5" padding="3mm" border="0.5pt solid #dddddd">
                                        ...
                                        <xsl:if test="$seller/ram:PostalTradeAddress">
                                            <fo:block>
                                                ...
                                                <xsl:if test="$seller/ram:PostalTradeAddress/ram:CitySubDivisionName">
                                                    <xsl:text> </xsl:text>
                                                    <xsl:value-of select="$seller/ram:PostalTradeAddress/ram:CitySubDivisionName"/>
                                                </xsl:if>
                                                <xsl:if test="$seller/ram:PostalTradeAddress/ram:CityName">
                                                    <xsl:text> </xsl:text>
                        ...
                        <fo:table-body>
                            <fo:table-row>
                                <fo:table-cell padding="2mm" border="0.5pt solid #dddddd" background-color="#e8e8e8">
                                    ...
                                    <fo:block font-size="{$font-size-small}">Doc No.</fo:block>
                                </fo:table-cell>
                            ...
                            <fo:table-row>
                                <fo:table-cell padding="2mm" border="0.5pt solid #dddddd" background-color="#e8e8e8">
                                    <fo:block font-weight="bold">ประเภทเอกสาร</fo:block>
                                    <fo:block font-size="{$font-size-small}">Type</fo:block>
                                </fo:table-cell>
                                <fo:table-cell padding="2mm" border="0.5pt solid #dddddd">
                                    <fo:block><xsl:value-of select="$doc/ram:TypeCode"/></fo:block>
                                </fo:table-cell>
                                <fo:table-cell padding="2mm" border="0.5pt solid #dddddd" background-color="#e8e8e8">
                                ...
                                <fo:table-cell padding="2mm" border="0.5pt solid #dddddd">
                                    <fo:block><xsl:value-of select="$settlement/ram:InvoiceCurrencyCode"/></fo:block>
                                </fo:table-cell>
                            </fo:table-row>
                        </fo:table-body>
                    </fo:table>
                    ...
                    <fo:table width="100%" table-layout="fixed" space-after="8mm"
                        ...
                        <fo:table-body>
                            ...
                            <xsl:if test="number($summation/ram:TaxTotalAmount) != 0">
                                <fo:table-row>
                                    <fo:table-cell><fo:block/></fo:table-cell>
                                    <fo:table-cell padding="2mm" border="0.5pt solid #dddddd" background-color="#f5f5f5">
                                        <fo:block text-align="right">
                            ...
                            <fo:table-row>
                                ...
                                <fo:table-cell padding="3mm" border="0.5pt solid #333333"
                                    ...
                                    <fo:block text-align="right" font-weight="bold" font-size="{$font-size-large}">
                                        <xsl:value-of select="$settlement/ram:InvoiceCurrencyCode"/>
                                        <xsl:text> </xsl:text>
